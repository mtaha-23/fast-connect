    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center max-w-5xl mx-auto">
          <ScrollAnimate animationId="hero-title" direction="up">
          ...
          <ScrollAnimate animationId="hero-description" direction="up" delay={100}>
          ...
          <ScrollAnimate animationId="hero-cta" direction="up" delay={200}>
          ...
          <ScrollAnimate animationId="hero-stats" direction="up" delay={300}>
